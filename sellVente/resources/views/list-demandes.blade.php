...
@section('content')
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-12">
                <h1 class="text-center mb-4">Liste des annonces qui ont des offres d'achat</h1>
                <div class="row">
                        ...
                        <div class="col mb-4">
                            <div class="tabs">
                                <div class="tab border_radius">
                                    <input type="checkbox" id="chck{{$item->ad_id}}" class="accordeon">
                                    <label class="tab-label font-weight-bold" for="chck{{$item->ad_id}}">
                                        Annonce : <h3><a href="/list-purchase/{{$item->ad_id}}">{{$item->name}}</a></h3>
                                    </label>
                                                        ...
                                                        <div class="card col-lg-4 col-md-4 mx-2 my-2 border_radius">
                                                            <div class="card-body">
                                                                ...
                                                                <p class="font-weight-bold mb-1">
                                                                    Nom du demandeur : 
                                                                    {{-- <span class="font-weight-normal"> {{ $li->name }} </span> --}}
                                                                </p>
                                                                {{-- <p class="font-weight-bold mb-1">
                                                                ...
                                                                <p class="font-weight-bold mb-1">
                                                                    Téléphone : 
                                                                    {{-- <span class="font-weight-normal"> {{ $li->phone }} </span> --}}
                                                                </p>
                                                                <p class="font-weight-bold mb-1">
                                                                    Adresse courriel : 
                                                                    {{-- <span class="font-weight-normal"> {{ $li->email }} </span> --}}
                                                                </p>
                                                                <p class="font-weight-bold mb-1">
                                                                    {{-- Joindre par : <span class="font-weight-normal"> {{ $li->join_preference }} </span> --}}
                                                                    Joindre par : 
                                                                    {{-- <span class="font-weight-normal">join_preference</span> --}}
                                                                </p>
                                                                <p class="font-weight-bold mb-1">
                                                                    Site Web : 
                                                                    {{-- <a href="{{ $li->link_website }}"><span class="font-weight-normal"> {{ $li->link_website }} </span></a> --}}
                                                                </p>
                                                                <p class="font-weight-bold mb-1">
                                                                    Facebook : 
                                                                    {{-- <a href="{{ $li->link_facebook }}"><span class="font-weight-normal"> {{ $li->link_facebook }} </span></a> --}}
                                                                </p>
                                                                <p class="font-weight-bold mb-1">
                                                                    LinkedIn : 
                                                                    {{-- <a href="{{ $li->link_linkedin }}"><span class="font-weight-normal"> {{$li->link_linkedin}} </span></a> --}}
                                                                </p>
                                                                {{-- <p class="font-weight-bold mb-1">
                                                                ...
                                                                <p class="font-weight-bold mt-3 mb-1">
                                                                    Compte rendu : 
                                                                    {{-- <span class="font-weight-normal"> {{ $li->state }} </span> --}}
                                                                </p>
                                                                ...
                                                                <p class="font-weight-bold mt-3 mb-1">
                                                                    Compte rendu : 
                                                                    {{-- <span class="font-weight-normal">vendu à quelqu'un d'autre</span> --}}
                                                                </p>
