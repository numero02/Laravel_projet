        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('register') }}" name="form">
              ...
              <div class="form-group row">
                <label for="join_preference" class="col-md-4 col-form-label text-md-right">{{ __('Façon de vous joindre :') }}</label>
                <div class="col-md-6">
                  <select  class="form-control" name="join_preference" id="join_preference">
                    <option value="Téléphone">Téléphone</option>
                    <option value="Adresse courriel">Adresse courriel</option>
                  </select>
                  @error('phone')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
