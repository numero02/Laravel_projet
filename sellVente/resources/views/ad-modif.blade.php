...
@section('content')
    ...
    <!-- *** cette page devrait s'appeler ad-edit.blade.php *** -->

      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">{{ __("Modification de l'annonce") }}</div>

            <div class="card-body">
              <form method="POST" action="/ad/{{$element['product']->id}}/update" name="form" class="myForm">
                  ...
                  <div class="form-group row if_product_hide_slow" >
                    ...
                    <div class="col-md-6">
                      <input type="text" 
                        ...
                        value="{{ $element['product']->realization_place }}"
                  ...
                  <div class="form-group row if_product_hide_slow">
                    ...
                    <div class="col-md-6">
                      <input type="text" 
                        ...
                        value="{{ $element['product']->duration }}"
